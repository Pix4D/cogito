// Taken from https://github.com/evanphx/go-hclog-slog and modified to use
// stdlib/log/slog instead of golang.org/x/exp/slog
//
// Will be removed as soon as we migrate the totality of cogito to stdlib/log/slog.
